...
void setup()
{
  ...
  // xTaskCreatePinnedToCore(check1, "check1", 2048, NULL, 1, NULL, 0);
  // xTaskCreatePinnedToCore(check2, "check2", 2048, NULL, 1, NULL, 1);
  // xTaskCreate(check1, "check1", 2048, NULL, 1, NULL);
  // xTaskCreate(check2, "check2", 2048, NULL, 1, NULL);
}
void loop()
{
}
