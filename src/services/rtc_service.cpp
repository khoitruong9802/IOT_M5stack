...
void rtc_service(void *parameter)
{
  ...
  for (;;)
  {
    ...
    lv_event_send(ui_Label1, (lv_event_code_t)LV_EVENT_RTC_UPDATE_LABEL, (void *)time1);
    lv_event_send(ui_Label2, (lv_event_code_t)LV_EVENT_RTC_UPDATE_LABEL, (void *)time2);
